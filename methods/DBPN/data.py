...
from dataset import DatasetFromFolderEval, DatasetFromFolder, DatasetFromFolderResize
...
def get_resized_set(lr_dir, upscale_factor):
    return DatasetFromFolderResize(lr_dir, upscale_factor,
                             transform=transform())